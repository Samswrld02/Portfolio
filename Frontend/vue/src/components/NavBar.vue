...
<template>
    <nav
        ...
        <div class="flex gap-4">
            <div class="px-4 py-2 bg-[#80061c] text-white rounded-sm">Resume</div>

            <!-- avatar -->
            <div @click="handleLogin" class="avatar">
                <div class="w-6 rounded-full  hover:transition ease-in-out hover:scale-120">
